...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("form_it_users");
}
...
class tDAL
{
	var $tblshqraed1formhratshqraedunet__form_data;
	var $tblshqraed1formhratshqraedunet__form_it_users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "form_data", "varname" => "shqraed1formhratshqraedunet__form_data", "altvarname" => "form_data", "connId" => "shqraed1formhratshqraedunet", "schema" => "", "connName" => "shqraed1_form_hr at shqraedu.n");
		$this->lstTables[] = array("name" => "form_it_users", "varname" => "shqraed1formhratshqraedunet__form_it_users", "altvarname" => "form_it_users", "connId" => "shqraed1formhratshqraedunet", "schema" => "", "connName" => "shqraed1_form_hr at shqraedu.n");
	}
