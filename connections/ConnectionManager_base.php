...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "shqraed1formhratshqraedunet" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["form_data"] = "shqraed1formhratshqraedunet";
		$connectionsIds["form_it_users"] = "shqraed1formhratshqraedunet";
