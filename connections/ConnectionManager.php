...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "shqraed1formhratshqraedunet";
		$data["connName"] = "shqraed1_form_hr at shqraedu.n";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;shqraed1_mrbdrm;mrbdrm0550969996;;shqraed1_form_hr;https://shqraedu.net/phprunner.php;0"; //currently unused

		$this->_connectionsIdByName["shqraed1_form_hr at shqraedu.n"] = "shqraed1formhratshqraedunet";

		$data["connInfo"] = array();
		$data["ODBCUID"] = "shqraed1_mrbdrm";
		$data["ODBCPWD"] = "mrbdrm0550969996";
		$data["leftWrap"] = "`";
		$data["rightWrap"] = "`";
		...
		$data["connInfo"][1] = "shqraed1_mrbdrm";
		$data["connInfo"][2] = "mrbdrm0550969996";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "shqraed1_form_hr";
		$data["connInfo"][5] = "https://shqraedu.net/phprunner.php"; //currently unused
		$data["connInfo"][6] = "0"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=shqraed1_mrbdrm;Pwd=mrbdrm0550969996;Database=shqraed1_form_hr;OPTION=3";
		// encription set
		...
		$connectionsData["shqraed1formhratshqraedunet"] = $data;
