...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "shqraed1formhratshqraedunet";
		}
		return $connId;
	}
...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	{
		return new ProjectSettings("form_it_users", PAGE_LIST);
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "form_data" ] = array( "url" => "form_data", "type" => 0 );
	$projectEntitiesReverse[ "form_data" ] = "form_data";
	$projectEntities[ "form_it_users" ] = array( "url" => "form_it_users", "type" => 0 );
	$projectEntitiesReverse[ "form_it_users" ] = "form_it_users";
}
