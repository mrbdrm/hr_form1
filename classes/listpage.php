...
class ListPage extends RunnerPage
{
	...
	{
		if( postvalue("pageType") == "register" && postvalue("table") == "form_it_users" )
			return new ProjectSettings( "form_it_users", PAGE_REGISTER, "", GLOBAL_PAGES);
