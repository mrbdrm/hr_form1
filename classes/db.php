...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "shqraed1formhratshqraedunet" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "form_data", "varname" => "shqraed1formhratshqraedunet__form_data", "altvarname" => "form_data", "connId" => "shqraed1formhratshqraedunet", "schema" => "", "connName" => "shqraed1_form_hr at shqraedu.n");
			$dalTables[$conn->connId][] = array("name" => "form_it_users", "varname" => "shqraed1formhratshqraedunet__form_it_users", "altvarname" => "form_it_users", "connId" => "shqraed1formhratshqraedunet", "schema" => "", "connName" => "shqraed1_form_hr at shqraedu.n");
		}
	}
