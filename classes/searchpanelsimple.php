...
class SearchPanelSimple extends SearchPanel {
	...
	{	
		...
		$searchOpt_mess = ($searchPanelAttrs['srchOptShowStatus'] ? "إخفاء خيارات البحث" : "تظهر خيارات البحث");
	...
	function DisplaySearchPanel()
	{
		...
		$showHideOpt_mess = $this->srchPanelAttrs['ctrlTypeComboStatus'] ? "إخفاء الخيارات" : "تظهر خيارات";		
